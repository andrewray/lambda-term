...
(* OASIS_START *)
(* DO NOT EDIT (digest: a5553349c7d247270aefeb2e1d23338b) *)
(*
...
let setup_t =
  {
            ...
            [
               ...
               Executable
                 ({
                   ...
                   {exec_custom = false; exec_main_is = "focus.ml"});
               Executable
                 ({
                     cs_name = "scroll";
                     cs_data = PropList.Data.create ();
                   ...
                   {exec_custom = false; exec_main_is = "scroll.ml"});
               Executable
                 ({
     ...
     oasis_version = "0.4.5";
     oasis_digest = Some "\191\001\247\235f\148\230\026o\141+\185,5\029>";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
